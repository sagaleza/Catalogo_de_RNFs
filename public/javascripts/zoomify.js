			...
			if (div_ref && img_ref) {
				...
				// Zoom levels
					...
					// Set default
						...
						//alert(zoom_levels.length);
						
						image_zoom(0);
						
//						if (zoom_levels.length >= 7) {
//							image_zoom(6);
//							
//						} else if (zoom_levels.length >= 6) {
//							image_zoom(4);
//						} else if (zoom_levels.length >= 5) {
//							image_zoom(3);
//						} else if (zoom_levels.length >= 4) {
//							image_zoom(2);
//						} else if (zoom_levels.length >= 3) {
//							image_zoom(1);
//						} else {
//							image_zoom(0);
//						}
